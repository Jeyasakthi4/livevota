...
export const EVENT_TEMPLATES: EventTemplate[] = [
  // 1. QUIZ — interactive game-show, countdown-focused, competitive knowledge arena
  {
    id: 'quiz-distributed-trivia',
    displayName: 'Quiz & Trivia Arena',
    personality: 'quiz',
    ...
    shortDescription: 'High-energy game-show buzzer rounds with instant countdowns and competitive scoring.',
    ...
    tagline: 'Playful knowledge-game atmosphere, floating question marks, and interactive competition energy',
  },

  // 2. COMPETITION — sports arena, stadium floodlights, live podium scoreboard
  {
    id: 'competition-hackathon-finals',
    displayName: 'Championship Arena',
    ...
    shortDescription: 'Stadium sports atmosphere with live podium leaderboards and sports-energy scoreboard tracking.',
    ...
    tagline: 'Bold stadium arena atmosphere, dramatic floodlights, and diagonal motion streaks',
  },

  // 3. BRAINSTORM — creative studio, organic idea constellation, thought clusters
  {
    id: 'brainstorm-design-sprint',
    displayName: 'Studio Brainstorm',
    ...
    shortDescription: 'Fluid creative studio with organic idea constellations, connected bezier nodes, and thought clusters.',
    ...
    tagline: 'Creative workspace atmosphere, floating idea nodes, sketches, and connected constellation lines',
  },

  // 4. PARTY / SOCIAL — premium celebration gala, champagne bokeh, elegant confetti
  {
    id: 'party-friday-social',
    displayName: 'Gala & Social Celebration',
    ...
    shortDescription: 'Sophisticated celebration atmosphere with drifting champagne confetti, warm bokeh, and festive energy.',
    ...
    tagline: 'Celebratory atmosphere with elegant metallic confetti, soft bokeh, and warm festive glows',
  },

  // 5. SURVEY — minimal, clean, data-focused, empirical research matrix
  {
    id: 'survey-runtime-benchmark',
    displayName: 'Empirical Research Survey',
    personality: 'survey',
    ...
    shortDescription: 'Tranquil data-first environment with Cartesian coordinate grids, oscilloscope waves, and statistical precision.',
    ...
    recommendedMinutes: 10,
    tagline: 'Clean research data atmosphere with subtle Cartesian grids, dots, and analytical waveforms',
  },

  // 6. CONFERENCE — futuristic, cinematic keynote stage, 3D perspective geometry
  {
    id: 'conf-keynote-direction',
    displayName: 'Keynote Conference Stage',
    ...
    shortDescription: 'Cinematic keynote auditorium atmosphere with 3D perspective stage geometry and projector light beams.',
  ...
  // 7. CLASSROOM — clean, educational, calm
  {
    id: 'classroom-comprehension',
    displayName: 'Academic Lecture Hall',
    ...
    shortDescription: 'Soft academic environment with notebook ruled lines and calm blue lecture lighting.',
  ...
  // 8. TEAM / WORK — professional, sophisticated, minimal
  {
    id: 'team-retro-focus',
    displayName: 'Executive Sprint Retro',
    ...
    shortDescription: 'Executive boardroom precision with structural architectural grid lines and laser guides.',
  ...
  // 9. LIVE EVENT — energetic, large typography, concert atmosphere
  {
    id: 'live-stadium-anthem',
    displayName: 'Concert & Arena Soundstage',
    ...
    shortDescription: 'High-voltage concert sound stage with sweeping volumetric spotlights and decibel surges.',
