...
export const THEME_CLASSROOM: PulseTheme = {
  ...
  tagline: 'Soft academic environment, notebook grid texture, calm blue tones',
  atmosphere: {
    previewBg: 'bg-[#060D18]',
    previewGradient: 'radial-gradient(circle at 50% 0%, rgba(59, 130, 246, 0.16) 0%, rgba(6, 13, 24, 0.95) 75%)',
    presentationBg: 'bg-[#050B14]',
    patternClass: 'pattern-notebook',
    overlayOpacity: 0.4,
  },
  accentColors: {
    primary: '#3b82f6',
  ...
  typography: {
    ...
    descriptionClass: 'font-sans text-xs sm:text-sm text-blue-100/70',
    badgeClass: 'font-mono text-[10px] font-semibold text-blue-300 tracking-wider uppercase',
    labelClass: 'font-sans text-sm font-medium text-blue-50',
  ...
  surface: {
    ...
    cardBg: 'bg-[#0B1526]/85',
    cardLeading: 'border-blue-500/50 bg-[#0F1E36] shadow-[0_0_25px_rgba(59,130,246,0.14)]',
    cardSelected: 'border-blue-400/80 bg-blue-950/40 ring-1 ring-blue-400/50',
  ...
  visualDetails: {
    ...
    personalityBadge: 'CLASSROOM · CALM BLUE ACADEMIC',
  ...
  presentation: {
    stageBackdrop: 'bg-[#050B14]',
    headerBadge: 'LECTURE HALL MODE',
    titleSize: 'text-3xl sm:text-5xl font-medium tracking-tight',
    qrBadgeStyle: 'border-blue-500/30 text-blue-300',
    layoutArchetype: 'lecture',
  },
  nodeBaseSize: 32,
  nodeGrowthFactor: 32,
  palette: [
    { id: 'cl1', label: 'Concept A', border: 'rgba(59, 130, 246, 0.45)', text: '#60a5fa', glow: 'rgba(59, 130, 246, 0.22)', bg: 'rgba(59, 130, 246, 0.07)', accent: '#3b82f6', barColor: '#3b82f6' },
    { id: 'cl2', label: 'Concept B', border: 'rgba(56, 189, 248, 0.45)', text: '#38bdf8', glow: 'rgba(56, 189, 248, 0.22)', bg: 'rgba(56, 189, 248, 0.07)', accent: '#0284c7', barColor: '#0284c7' },
    { id: 'cl3', label: 'Concept C', border: 'rgba(99, 102, 241, 0.45)', text: '#818cf8', glow: 'rgba(99, 102, 241, 0.22)', bg: 'rgba(99, 102, 241, 0.07)', accent: '#6366f1', barColor: '#6366f1' },
    { id: 'cl4', label: 'Concept D', border: 'rgba(45, 212, 191, 0.45)', text: '#2dd4bf', glow: 'rgba(45, 212, 191, 0.22)', bg: 'rgba(45, 212, 191, 0.07)', accent: '#0d9488', barColor: '#0d9488' },
  ],
  leadPalette: {
    ...
    badgeBg: 'rgba(23, 37, 84, 0.75)',
    badgeBorder: 'rgba(59, 130, 246, 0.4)',
  },
  cssVariables: {
    '--pulse-primary-color': '#3b82f6',
    '--pulse-secondary-color': '#60a5fa',
    '--pulse-theme-glow': 'rgba(59, 130, 246, 0.22)',
    '--pulse-theme-border': 'rgba(59, 130, 246, 0.35)',
  ...
  tailwindClasses: {
    ...
    containerGlow: 'shadow-[0_0_45px_rgba(59,130,246,0.06)]',
    gridBg: 'bg-[#060D18]',
    cardBorder: 'border-blue-500/18',
    cardBg: 'bg-[#0B1526]/90',
    cardLeading: 'border-blue-500/50 bg-[#0F1E36] shadow-[0_0_25px_rgba(59,130,246,0.15)]',
    cardSelected: 'border-blue-400/80 bg-blue-950/40 ring-1 ring-blue-400/50',
    badge: 'border-blue-500/30 bg-blue-950/50 text-blue-300',
